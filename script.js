...
let renderedProducts = (async function() {
    let dataCollection = await sendRequest(url);
...
async function showProducts() {
    ...
    await renderedProducts;
    wrapper.removeChild(loader);
    productList.classList.toggle('active');
    button.innerHTML === 'Show products' && !document.querySelector('.error') ? button.innerHTML = 'Hide products' : button.innerHTML = 'Show products';
}
